...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SELEN Jewelry — Joyería de Lujo con Esmeraldas y Oro | Colombia" },
      { property: "og:description", content: "SELEN Jewelry: joyería femenina premium hecha en Colombia. Piezas únicas en oro 18K con esmeraldas colombianas y diamantes. Diseños personalizados y joyería sobre pedido. Envíos nacionales e internacionales." },
      ...
      { name: "twitter:title", content: "SELEN Jewelry — Joyería de Lujo con Esmeraldas y Oro | Colombia" },
      { name: "twitter:description", content: "SELEN Jewelry: joyería femenina premium hecha en Colombia. Piezas únicas en oro 18K con esmeraldas colombianas y diamantes. Diseños personalizados y joyería sobre pedido. Envíos nacionales e internacionales." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/15980785-6166-4f56-a4a0-4bb447325f4d/id-preview-dadf5324--c54a2510-21b3-495c-a6cf-7f1527cd30b6.lovable.app-1778201337198.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/15980785-6166-4f56-a4a0-4bb447325f4d/id-preview-dadf5324--c54a2510-21b3-495c-a6cf-7f1527cd30b6.lovable.app-1778201337198.png" },
